...
sensor_df = spark \
    ...
    .option("subscribe", "akbar-data-raw") \
    .option("startingOffsets", "earliest") \
    .option("kafka.security.protocol","SASL_SSL") \
    .option("kafka.sasl.mechanism", "PLAIN") \
    .option("kafka.sasl.username","ZPGX5AS3WRSI7ZUI") \
    .option("kafka.sasl.password", "qQUiYQb721qjj3C2VivFt+GcwMtmaba3rgiYt0YxconSG9HuZZJxqBlezAtjcZ0p") \
    .option("kafka.sasl.jaas.config", """org.apache.kafka.common.security.plain.PlainLoginModule required username="ZPGX5AS3WRSI7ZUI" password="qQUiYQb721qjj3C2VivFt+GcwMtmaba3rgiYt0YxconSG9HuZZJxqBlezAtjcZ0p";""") \
    .load()
